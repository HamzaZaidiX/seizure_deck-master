    ...
    Column(
      ...
      children: [
        IconButton(
          icon: Icon(
            MdiIcons.medication,
            color: selectedMedicine == MedicineType.Syrup ? Colors.purple : Colors.grey,
          ),
          onPressed: () {
            setState(() {
    ...
    Column(
      ...
      children: [
        IconButton(
          icon: Icon(
            MdiIcons.pill,
            color: selectedMedicine == MedicineType.Tablets ? Colors.purple : Colors.grey,
          ),
          onPressed: () {
            setState(() {
    ...
    Column(
      ...
      children: [
        IconButton(
          icon: Icon(
            MdiIcons.needle,
            color: selectedMedicine == MedicineType.Syringe ? Colors.purple : Colors.grey,
          ),
          onPressed: () {
            setState(() {
                    ...
                    style: TextButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(
                        borderRadius:
                            BorderRadius.circular(15.0), // Button shape
                        side: BorderSide(
                            width: 2, color: Color.fromARGB(255, 255, 255, 255)), // Border
                      ),
                    ),
                    child: const Text(
                      "Select Time",
